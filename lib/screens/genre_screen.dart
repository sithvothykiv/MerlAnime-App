...
class _GenreScreenState extends State<GenreScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return MerlAnimeScaffoldWithBackButton(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return AnimatedBuilder(
                        ...
                        builder: (BuildContext context, Widget? child) {
                          return Transform(
                            transform: Matrix4.translationValues(0, 100 * (1.0 - MerlAnimeCurveAnimation(animationController, index, list.length).value), 0),
                            child: child,
                          );
                        },
                      );
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      _pageIndex.toString(),
                      style: MerlAnimeTheme.darkTextTheme.headline3!.copyWith(
                        color: Colors.black,
                      ),
                    ),
                  ),
