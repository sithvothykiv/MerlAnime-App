...
class _SearchScreenState extends State<SearchScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    controller = AnimationController(duration: Duration(milliseconds: merlAniAnimationDuration), vsync: this);
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return AnimatedBuilder(
                            ...
                            builder: (BuildContext context, Widget? child) {
                              return Transform(
                                transform: Matrix4.translationValues(0, 100 * (1.0 - MerlAnimeCurveAnimation(controller, index, list.length).value), 0),
                                child: child,
                              );
                            },
                          );
