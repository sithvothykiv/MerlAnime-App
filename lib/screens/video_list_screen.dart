...
import '../utils/merl_anime_helper.dart';
import '../utils/constants.dart';
import '../utils/routes.dart';
import '../widgets/anime_detail_header.dart';
import '../widgets/merl_anime_animation.dart';
import '../widgets/merl_anime_scaffold.dart';
...
class _VideoListScreenState extends State<VideoListScreen> with SingleTickerProviderStateMixin {
  ...
  final BookMarkController bookMarkManager = Get.find();
  ...
  void initState() {
    super.initState();
    animationController = AnimationController(duration: Duration(milliseconds: merlAniAnimationDuration), vsync: this);
  ...
  Widget build(BuildContext context) {
    return Hero(
      ...
      child: MerlAnimeScaffoldWithBackButton(
        appBarTitle: 'MerlAnime',
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Episodes',
                                      style: MerlAnimeTheme.darkTextTheme.headline5,
                                    ),
                                    GetBuilder<BookMarkController>(
                                      builder: (_) => TextButton.icon(
                                          ...
                                          label: Text(
                                            'BookMark',
                                            style: MerlAnimeTheme.darkTextTheme.bodyText1!.copyWith(color: Color.fromARGB(255, 233, 5, 39)),
                                          )),
                                    )
                                  ],
                                ),
                              ...
                              anime.episodes!.isNotEmpty
                                          ...
                                          return Obx(
                                            () => AnimatedBuilder(
                                              ...
                                              child: Material(
                                                ...
                                                color: selectedIndex.value == index ? Color.fromARGB(255, 50, 55, 66) : Color.fromARGB(255, 233, 5, 39).withAlpha(200),
                                                child: InkWell(
                                                  borderRadius: BorderRadius.circular(10),
                                                  onTap: () async {
                                                    ...
                                                    await Get.toNamed(Routes.mediaFetchScreen, arguments: {
                                                      'animeUrl': epChunkList[index].link.toString(),
                                                      'name': name.toString(),
                                                    });
                                                  },
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: MerlAnimeTheme.darkTextTheme.headline6,
                                                    ),
                                                  ),
                                                ),
                                              ),
                                              builder: (context, child) {
                                                return Transform(
                                                  transform: Matrix4.translationValues(0, 100 * (1.0 - MerlAnimeCurveAnimation(animationController, index, epChunkList.length).value), 0),
                                                  child: child,
                                                );
                                              },
                                            ),
                                  ...
                                  : Padding(
                                      ...
                                      child: Text(
                                        'Coming Soon ..',
                                        style: MerlAnimeTheme.darkTextTheme.subtitle2,
                                      ),
                                    ),
                            ],
                          ),
