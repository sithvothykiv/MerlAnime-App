                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return AnimatedBuilder(
                                ...
                                builder: (context, child) {
                                  return Transform(
                                    transform: Matrix4.translationValues(-200 * (1.0 - MerlAnimeCurveAnimation(animationController, index, popularList.length).value), 0, 0),
                                    child: child,
                                  );
                                },
                              );
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return AnimatedBuilder(
                                ...
                                builder: (context, child) {
                                  return Transform(
                                    transform: Matrix4.translationValues(-200 * (1.0 - MerlAnimeCurveAnimation(animationController, index, recentlyAdded.length).value), 0, 0),
                                    child: child,
                                  );
                                },
                              );
