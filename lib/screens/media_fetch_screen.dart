...
import '../widgets/merl_anime_play_web_view.dart';
...
class _MediaFetchScreenState extends State<MediaFetchScreen> {
  ...
  final animeName = Get.arguments['name'];
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Image.asset(
                    hasError.value ? 'assets/gif/anime-cry.gif' : 'assets/gif/anime${1 + _random.nextInt(28)}.gif',
                    width: 350,
                    height: 200,
                  ),
                ),
                  ...
                  () => Visibility(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text(
                        ...
                        style: MerlAnimeTheme.darkTextTheme.headline3!.copyWith(fontSize: 17.0),
                      ),
                    ),
                  ),
                ),
